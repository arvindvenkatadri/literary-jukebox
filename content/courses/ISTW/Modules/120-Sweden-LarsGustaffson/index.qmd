...
```{r}
#| echo: false
#| fig.cap: "Lars Gustafsson (1936-2023)"
#| fig.align: "center"
#| out.width: "30%"
#| out.height: "30%"

knitr::include_graphics("Lars_Gustafsson.jpg")
...
{{< pdf "../../../../materials/pdfs/LarsGustafsson-Greatness-Strikes-Where-It-Pleases.pdf">}}
...
-   Nature Deprivation, and Nature Deficit Disorder
-   Natural Shapes are Fractals more often than not, and the human brain is wired to recognize and respond to fractals. 
-   Epiphanies
...
::: {#fig-logical}
<center>
{{< video https://youtu.be/vD7HJcpJD9U width="560" height="400" align="center" title="The Logical Song" >}}
</center>
Super Tramp performing "The Logical Song" in 1979
:::
